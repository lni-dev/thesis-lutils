...
public class MediumTestStruct4 extends Struct<MediumTestStruct4> implements NativeResource {
    ...
    /**
     * Returns a new {@link MediumTestStruct4.Buffer} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static MediumTestStruct4.Buffer malloc(int capacity) {
        return new Buffer(nmemAllocChecked(__checkMalloc(capacity, SIZEOF)), capacity);
    }

    /**
     * Returns a new {@link MediumTestStruct4.Buffer} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static MediumTestStruct4.Buffer calloc(int capacity) {
        return new Buffer(nmemCallocChecked(capacity, SIZEOF), capacity);
    }

    /**
     * Returns a new {@link MediumTestStruct4.Buffer} instance allocated with {@link BufferUtils}.
     *
     * @param capacity the buffer capacity
     */
    public static MediumTestStruct4.Buffer create(int capacity) {
        ByteBuffer container = __create(capacity, SIZEOF);
        return new Buffer(memAddress(container), container, -1, 0, capacity, capacity);
    }

    /**
     * Create a {@link MediumTestStruct4.Buffer} instance at the specified memory.
     *
     * @param address  the memory address
     * @param capacity the buffer capacity
     */
    public static MediumTestStruct4.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static MediumTestStruct4.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    /**
     * Returns a new {@link MediumTestStruct4.Buffer} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static MediumTestStruct4.Buffer malloc(int capacity, MemoryStack stack) {
        return new Buffer(stack.nmalloc(ALIGNOF, capacity * SIZEOF), capacity);
    }

    /**
     * Returns a new {@link MediumTestStruct4.Buffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static MediumTestStruct4.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<MediumTestStruct4, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link MediumTestStruct1} to the {@code aMediumTestStruct1} field. */
        public MediumTestStruct4.Buffer aMediumTestStruct1(MediumTestStruct1 value) { MediumTestStruct4.naMediumTestStruct1(address(), value); return this; }
        /** Passes the {@code aMediumTestStruct1} field to the specified {@link java.util.function.Consumer Consumer}. */
        public MediumTestStruct4.Buffer aMediumTestStruct1(java.util.function.Consumer<MediumTestStruct1> consumer) { consumer.accept(aMediumTestStruct1()); return this; }
        /** Copies the specified {@link MediumTestStruct2} to the {@code aMediumTestStruct2} field. */
        public MediumTestStruct4.Buffer aMediumTestStruct2(MediumTestStruct2 value) { MediumTestStruct4.naMediumTestStruct2(address(), value); return this; }
        /** Passes the {@code aMediumTestStruct2} field to the specified {@link java.util.function.Consumer Consumer}. */
        public MediumTestStruct4.Buffer aMediumTestStruct2(java.util.function.Consumer<MediumTestStruct2> consumer) { consumer.accept(aMediumTestStruct2()); return this; }
        /** Copies the specified {@link DoubleBuffer} to the {@code aFloat64Array} field. */
        public MediumTestStruct4.Buffer aFloat64Array(@NativeType("double[13]") DoubleBuffer value) { MediumTestStruct4.naFloat64Array(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code aFloat64Array} field. */
        public MediumTestStruct4.Buffer aFloat64Array(int index, double value) { MediumTestStruct4.naFloat64Array(address(), index, value); return this; }
        /** Sets the specified value to the {@code aByte} field. */
        public MediumTestStruct4.Buffer aByte(@NativeType("int8_t") byte value) { MediumTestStruct4.naByte(address(), value); return this; }
        /** Copies the specified {@link SmallTestStruct6} to the {@code aSmallTestStruct6} field. */
        public MediumTestStruct4.Buffer aSmallTestStruct6(SmallTestStruct6 value) { MediumTestStruct4.naSmallTestStruct6(address(), value); return this; }
        /** Passes the {@code aSmallTestStruct6} field to the specified {@link java.util.function.Consumer Consumer}. */
        public MediumTestStruct4.Buffer aSmallTestStruct6(java.util.function.Consumer<SmallTestStruct6> consumer) { consumer.accept(aSmallTestStruct6()); return this; }
        /** Sets the specified value to the {@code aShort} field. */
        public MediumTestStruct4.Buffer aShort(@NativeType("int16_t") short value) { MediumTestStruct4.naShort(address(), value); return this; }
        /** Copies the specified {@link SmallTestStruct7} to the {@code aSmallTestStruct7} field. */
        public MediumTestStruct4.Buffer aSmallTestStruct7(SmallTestStruct7 value) { MediumTestStruct4.naSmallTestStruct7(address(), value); return this; }
        /** Passes the {@code aSmallTestStruct7} field to the specified {@link java.util.function.Consumer Consumer}. */
        public MediumTestStruct4.Buffer aSmallTestStruct7(java.util.function.Consumer<SmallTestStruct7> consumer) { consumer.accept(aSmallTestStruct7()); return this; }
