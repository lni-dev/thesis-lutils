...
public class SmallTestStruct4 extends Struct<SmallTestStruct4> implements NativeResource {
    ...
    /**
     * Returns a new {@link SmallTestStruct4.Buffer} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct4.Buffer malloc(int capacity) {
        return new Buffer(nmemAllocChecked(__checkMalloc(capacity, SIZEOF)), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct4.Buffer} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct4.Buffer calloc(int capacity) {
        return new Buffer(nmemCallocChecked(capacity, SIZEOF), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct4.Buffer} instance allocated with {@link BufferUtils}.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct4.Buffer create(int capacity) {
        ByteBuffer container = __create(capacity, SIZEOF);
        return new Buffer(memAddress(container), container, -1, 0, capacity, capacity);
    }

    /**
     * Create a {@link SmallTestStruct4.Buffer} instance at the specified memory.
     *
     * @param address  the memory address
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct4.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static SmallTestStruct4.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    /**
     * Returns a new {@link SmallTestStruct4.Buffer} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct4.Buffer malloc(int capacity, MemoryStack stack) {
        return new Buffer(stack.nmalloc(ALIGNOF, capacity * SIZEOF), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct4.Buffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct4.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<SmallTestStruct4, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code aPointer} field. */
        public SmallTestStruct4.Buffer aPointer(@NativeType("int64_t") long value) { SmallTestStruct4.naPointer(address(), value); return this; }
        /** Copies the specified {@link SmallTestStruct1} to the {@code aSmallTestStruct1} field. */
        public SmallTestStruct4.Buffer aSmallTestStruct1(SmallTestStruct1 value) { SmallTestStruct4.naSmallTestStruct1(address(), value); return this; }
        /** Passes the {@code aSmallTestStruct1} field to the specified {@link java.util.function.Consumer Consumer}. */
        public SmallTestStruct4.Buffer aSmallTestStruct1(java.util.function.Consumer<SmallTestStruct1> consumer) { consumer.accept(aSmallTestStruct1()); return this; }
