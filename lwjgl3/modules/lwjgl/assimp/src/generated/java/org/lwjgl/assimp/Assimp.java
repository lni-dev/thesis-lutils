...
public class Assimp {
    ...
    public static final class Functions {
        ...
        public static final long
            ...
            useStruct                                      = apiGetFunctionAddress(ASSIMP, "aiuseStruct"),
    ...
    /** {@code void aiuseStruct(SmallTestStruct1 * struct)} */
    public static void naiuseStruct(long struct) {
        long __functionAddress = Functions.useStruct;
        invokePV(struct, __functionAddress);
    }

    /** {@code void aiuseStruct(SmallTestStruct1 * struct)} */
    public static void aiuseStruct(@NativeType("SmallTestStruct1 *") SmallTestStruct1 struct) {
        naiuseStruct(struct.address());
    }
