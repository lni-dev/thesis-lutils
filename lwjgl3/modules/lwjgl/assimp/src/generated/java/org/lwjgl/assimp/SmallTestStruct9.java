...
public class SmallTestStruct9 extends Struct<SmallTestStruct9> implements NativeResource {
    ...
    /**
     * Returns a new {@link SmallTestStruct9.Buffer} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct9.Buffer malloc(int capacity) {
        return new Buffer(nmemAllocChecked(__checkMalloc(capacity, SIZEOF)), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct9.Buffer} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct9.Buffer calloc(int capacity) {
        return new Buffer(nmemCallocChecked(capacity, SIZEOF), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct9.Buffer} instance allocated with {@link BufferUtils}.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct9.Buffer create(int capacity) {
        ByteBuffer container = __create(capacity, SIZEOF);
        return new Buffer(memAddress(container), container, -1, 0, capacity, capacity);
    }

    /**
     * Create a {@link SmallTestStruct9.Buffer} instance at the specified memory.
     *
     * @param address  the memory address
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct9.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static SmallTestStruct9.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    /**
     * Returns a new {@link SmallTestStruct9.Buffer} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct9.Buffer malloc(int capacity, MemoryStack stack) {
        return new Buffer(stack.nmalloc(ALIGNOF, capacity * SIZEOF), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct9.Buffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct9.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<SmallTestStruct9, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link SmallTestStruct8} to the {@code aSmallTestStruct8} field. */
        public SmallTestStruct9.Buffer aSmallTestStruct8(SmallTestStruct8 value) { SmallTestStruct9.naSmallTestStruct8(address(), value); return this; }
        /** Passes the {@code aSmallTestStruct8} field to the specified {@link java.util.function.Consumer Consumer}. */
        public SmallTestStruct9.Buffer aSmallTestStruct8(java.util.function.Consumer<SmallTestStruct8> consumer) { consumer.accept(aSmallTestStruct8()); return this; }
        /** Sets the specified value to the {@code aSmallInt} field. */
        public SmallTestStruct9.Buffer aSmallInt(@NativeType("int32_t") int value) { SmallTestStruct9.naSmallInt(address(), value); return this; }
        /** Sets the specified value to the {@code aSecondSmallInt} field. */
        public SmallTestStruct9.Buffer aSecondSmallInt(@NativeType("int32_t") int value) { SmallTestStruct9.naSecondSmallInt(address(), value); return this; }
