...
public class SmallTestStruct5 extends Struct<SmallTestStruct5> implements NativeResource {
    ...
    /**
     * Returns a new {@link SmallTestStruct5.Buffer} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct5.Buffer malloc(int capacity) {
        return new Buffer(nmemAllocChecked(__checkMalloc(capacity, SIZEOF)), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct5.Buffer} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct5.Buffer calloc(int capacity) {
        return new Buffer(nmemCallocChecked(capacity, SIZEOF), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct5.Buffer} instance allocated with {@link BufferUtils}.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct5.Buffer create(int capacity) {
        ByteBuffer container = __create(capacity, SIZEOF);
        return new Buffer(memAddress(container), container, -1, 0, capacity, capacity);
    }

    /**
     * Create a {@link SmallTestStruct5.Buffer} instance at the specified memory.
     *
     * @param address  the memory address
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct5.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static SmallTestStruct5.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    /**
     * Returns a new {@link SmallTestStruct5.Buffer} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct5.Buffer malloc(int capacity, MemoryStack stack) {
        return new Buffer(stack.nmalloc(ALIGNOF, capacity * SIZEOF), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct5.Buffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct5.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<SmallTestStruct5, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code aPointer64} field. */
        public SmallTestStruct5.Buffer aPointer64(@NativeType("int64_t") long value) { SmallTestStruct5.naPointer64(address(), value); return this; }
        /** Sets the specified value to the {@code aShort1} field. */
        public SmallTestStruct5.Buffer aShort1(@NativeType("int16_t") short value) { SmallTestStruct5.naShort1(address(), value); return this; }
        /** Copies the specified {@link LongBuffer} to the {@code aLong3} field. */
        public SmallTestStruct5.Buffer aLong3(@NativeType("int64_t[3]") LongBuffer value) { SmallTestStruct5.naLong3(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code aLong3} field. */
        public SmallTestStruct5.Buffer aLong3(int index, @NativeType("int64_t") long value) { SmallTestStruct5.naLong3(address(), index, value); return this; }
