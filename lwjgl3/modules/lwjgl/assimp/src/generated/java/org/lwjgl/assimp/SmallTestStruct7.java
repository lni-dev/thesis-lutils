...
public class SmallTestStruct7 extends Struct<SmallTestStruct7> implements NativeResource {
    ...
    /**
     * Returns a new {@link SmallTestStruct7.Buffer} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct7.Buffer malloc(int capacity) {
        return new Buffer(nmemAllocChecked(__checkMalloc(capacity, SIZEOF)), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct7.Buffer} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct7.Buffer calloc(int capacity) {
        return new Buffer(nmemCallocChecked(capacity, SIZEOF), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct7.Buffer} instance allocated with {@link BufferUtils}.
     *
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct7.Buffer create(int capacity) {
        ByteBuffer container = __create(capacity, SIZEOF);
        return new Buffer(memAddress(container), container, -1, 0, capacity, capacity);
    }

    /**
     * Create a {@link SmallTestStruct7.Buffer} instance at the specified memory.
     *
     * @param address  the memory address
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct7.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static SmallTestStruct7.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    /**
     * Returns a new {@link SmallTestStruct7.Buffer} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct7.Buffer malloc(int capacity, MemoryStack stack) {
        return new Buffer(stack.nmalloc(ALIGNOF, capacity * SIZEOF), capacity);
    }

    /**
     * Returns a new {@link SmallTestStruct7.Buffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    public static SmallTestStruct7.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<SmallTestStruct7, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code aInt} field. */
        public SmallTestStruct7.Buffer aInt(@NativeType("int32_t") int value) { SmallTestStruct7.naInt(address(), value); return this; }
        /** Sets the specified value to the {@code aPointer} field. */
        public SmallTestStruct7.Buffer aPointer(@NativeType("int64_t") long value) { SmallTestStruct7.naPointer(address(), value); return this; }
        /** Sets the specified value to the {@code aSecondInt} field. */
        public SmallTestStruct7.Buffer aSecondInt(@NativeType("int32_t") int value) { SmallTestStruct7.naSecondInt(address(), value); return this; }
        /** Sets the specified value to the {@code aThirdInt} field. */
        public SmallTestStruct7.Buffer aThirdInt(@NativeType("int32_t") int value) { SmallTestStruct7.naThirdInt(address(), value); return this; }
