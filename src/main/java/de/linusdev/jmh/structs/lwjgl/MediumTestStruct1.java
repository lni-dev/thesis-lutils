...
public class MediumTestStruct1 extends Struct<MediumTestStruct1> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<MediumTestStruct1, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code aLong} field. */
        public Buffer aLong(@NativeType("int64_t") long value) { MediumTestStruct1.naLong(address(), value); return this; }
        /** Sets the specified value to the {@code aSecondLong} field. */
        public Buffer aSecondLong(@NativeType("int64_t") long value) { MediumTestStruct1.naSecondLong(address(), value); return this; }
        /** Sets the specified value to the {@code aThirdLong} field. */
        public Buffer aThirdLong(@NativeType("int64_t") long value) { MediumTestStruct1.naThirdLong(address(), value); return this; }
        /** Copies the specified {@link IntBuffer} to the {@code aInt4} field. */
        public Buffer aInt4(@NativeType("int32_t[4]") IntBuffer value) { MediumTestStruct1.naInt4(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code aInt4} field. */
        public Buffer aInt4(int index, @NativeType("int32_t") int value) { MediumTestStruct1.naInt4(address(), index, value); return this; }
        /** Sets the specified value to the {@code aShort} field. */
        public Buffer aShort(@NativeType("int16_t") short value) { MediumTestStruct1.naShort(address(), value); return this; }
        /** Copies the specified {@link SmallTestStruct1} to the {@code aSubStruct} field. */
        public Buffer aSubStruct(SmallTestStruct1 value) { MediumTestStruct1.naSubStruct(address(), value); return this; }
        /** Passes the {@code aSubStruct} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer aSubStruct(java.util.function.Consumer<SmallTestStruct1> consumer) { consumer.accept(aSubStruct()); return this; }
        /** Copies the specified {@link SmallTestStruct2} to the {@code aSecondSubStruct} field. */
        public Buffer aSecondSubStruct(SmallTestStruct2 value) { MediumTestStruct1.naSecondSubStruct(address(), value); return this; }
        /** Passes the {@code aSecondSubStruct} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer aSecondSubStruct(java.util.function.Consumer<SmallTestStruct2> consumer) { consumer.accept(aSecondSubStruct()); return this; }
        /** Copies the specified {@link ByteBuffer} to the {@code aByteArray} field. */
        public Buffer aByteArray(@NativeType("int8_t[20]") ByteBuffer value) { MediumTestStruct1.naByteArray(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code aByteArray} field. */
        public Buffer aByteArray(int index, @NativeType("int8_t") byte value) { MediumTestStruct1.naByteArray(address(), index, value); return this; }
