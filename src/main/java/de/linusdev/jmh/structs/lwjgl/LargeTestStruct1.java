...
public class LargeTestStruct1 extends Struct<LargeTestStruct1> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<LargeTestStruct1, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link MediumTestStruct1.Buffer} to the {@code mediumTestStruct1Array} field. */
        public Buffer mediumTestStruct1Array(@NativeType("MediumTestStruct1[600]") MediumTestStruct1.Buffer value) { LargeTestStruct1.nmediumTestStruct1Array(address(), value); return this; }
        /** Copies the specified {@link MediumTestStruct1} at the specified index of the {@code mediumTestStruct1Array} field. */
        public Buffer mediumTestStruct1Array(int index, MediumTestStruct1 value) { LargeTestStruct1.nmediumTestStruct1Array(address(), index, value); return this; }
        /** Passes the {@code mediumTestStruct1Array} field to the specified {@link java.util.function.Consumer Consumer}. */
        ...
        /** Copies the specified {@link SmallTestStruct3.Buffer} to the {@code smallTestStruct3Array} field. */
        public Buffer smallTestStruct3Array(@NativeType("SmallTestStruct3[1200]") SmallTestStruct3.Buffer value) { LargeTestStruct1.nsmallTestStruct3Array(address(), value); return this; }
        /** Copies the specified {@link SmallTestStruct3} at the specified index of the {@code smallTestStruct3Array} field. */
        public Buffer smallTestStruct3Array(int index, SmallTestStruct3 value) { LargeTestStruct1.nsmallTestStruct3Array(address(), index, value); return this; }
        /** Passes the {@code smallTestStruct3Array} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer smallTestStruct3Array(java.util.function.Consumer<SmallTestStruct3.Buffer> consumer) { consumer.accept(smallTestStruct3Array()); return this; }
        /** Passes the element at {@code index} of the {@code smallTestStruct3Array} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer smallTestStruct3Array(int index, java.util.function.Consumer<SmallTestStruct3> consumer) { consumer.accept(smallTestStruct3Array(index)); return this; }
        /** Copies the specified {@link IntBuffer} to the {@code intArray} field. */
        public Buffer intArray(@NativeType("int32_t[100000]") IntBuffer value) { LargeTestStruct1.nintArray(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code intArray} field. */
        public Buffer intArray(int index, @NativeType("int32_t") int value) { LargeTestStruct1.nintArray(address(), index, value); return this; }
