...
public class MediumTestStruct5 extends Struct<MediumTestStruct5> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<MediumTestStruct5, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link ByteBuffer} to the {@code aFloat64Array} field. */
        public Buffer aFloat64Array(@NativeType("int8_t[21]") ByteBuffer value) { MediumTestStruct5.naFloat64Array(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code aFloat64Array} field. */
        public Buffer aFloat64Array(int index, @NativeType("int8_t") byte value) { MediumTestStruct5.naFloat64Array(address(), index, value); return this; }
        /** Copies the specified {@link MediumTestStruct3} to the {@code aMediumTestStruct3} field. */
        public Buffer aMediumTestStruct3(MediumTestStruct3 value) { MediumTestStruct5.naMediumTestStruct3(address(), value); return this; }
        /** Passes the {@code aMediumTestStruct3} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer aMediumTestStruct3(java.util.function.Consumer<MediumTestStruct3> consumer) { consumer.accept(aMediumTestStruct3()); return this; }
        /** Copies the specified {@link SmallTestStruct2} to the {@code aSmallTestStruct2} field. */
        public Buffer aSmallTestStruct2(SmallTestStruct2 value) { MediumTestStruct5.naSmallTestStruct2(address(), value); return this; }
        /** Passes the {@code aSmallTestStruct2} field to the specified {@link java.util.function.Consumer Consumer}. */
        ...
        /** Sets the specified value to the {@code aPointer64} field. */
        public Buffer aPointer64(@NativeType("int64_t") long value) { MediumTestStruct5.naPointer64(address(), value); return this; }
        /** Copies the specified {@link SmallTestStruct7.Buffer} to the {@code aStructArray} field. */
        public Buffer aStructArray(@NativeType("SmallTestStruct7[5]") SmallTestStruct7.Buffer value) { MediumTestStruct5.naStructArray(address(), value); return this; }
        /** Copies the specified {@link SmallTestStruct7} at the specified index of the {@code aStructArray} field. */
        public Buffer aStructArray(int index, SmallTestStruct7 value) { MediumTestStruct5.naStructArray(address(), index, value); return this; }
        /** Passes the {@code aStructArray} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer aStructArray(java.util.function.Consumer<SmallTestStruct7.Buffer> consumer) { consumer.accept(aStructArray()); return this; }
        /** Passes the element at {@code index} of the {@code aStructArray} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer aStructArray(int index, java.util.function.Consumer<SmallTestStruct7> consumer) { consumer.accept(aStructArray(index)); return this; }
